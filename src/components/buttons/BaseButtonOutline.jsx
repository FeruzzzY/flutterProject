...
const BaseButtonOutline = (props) => {
  return (
    <button
      {...props}
      className={`baseButtonOutline flex justify-center w-full lg:py-4 py-2.5 lg:px-8 px-4 border rounded-[100px] duration-200 lg:text-base text-xs hover:text-white
